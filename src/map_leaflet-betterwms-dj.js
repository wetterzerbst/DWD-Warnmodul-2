...
/*    $.ajax({
  ...
  showGetFeatureInfoJson: function (latlng, data) {  var newstyle=true  //false edit here
    ...
    content += "text<br><a target='dwd' href='https://www.dwd.de/warnungen'>DWD</a> "+new Date(data.features[0].properties.SENT).toLocaleTimeString('de',{hour:"2-digit",minute:"2-digit"});
